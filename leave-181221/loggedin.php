...
if ($conn->connect_error) {
 ...
 $result = mysqli_query($conn,"SELECT * FROM students WHERE email = '$v'");
    if (!$result) {
...
?>' readonly>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" name="parent" id="pname" placeholder="">
                        <div class="invalid-feedback">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="pphone" id="pphone" placeholder="">
                            <div class="invalid-feedback" style="width: 100%;">
                                Your Moile Numer is required.
                            </div>
                        </div>
