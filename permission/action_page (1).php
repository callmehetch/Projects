...
$pdf->Cell(0,50,'Name: '.$name,0,0);
 ...
 $pdf->Ln(10);
 $pdf->Cell(0,50,'Fathers name: '.$email,0,0);
 $pdf->Ln(10);
 $pdf->Cell(0,50,' parent Mobile Number: '.$mobile,0,0);
 $pdf->Ln(10);
 $pdf->Cell(0,50,'student mobile number: '.$hallno,0,0);
 $pdf->Ln(10);
 $pdf->Cell(0,50,'DATE of LEAVING: '.$purpose,0,0);
 $pdf->Ln(10);
 $pdf->Cell(0,50,'return date '.$strength,0,0);
 $pdf->Ln(10);
 $pdf->Cell(42,50,' out Time: From '.$fromtime,0,0);
