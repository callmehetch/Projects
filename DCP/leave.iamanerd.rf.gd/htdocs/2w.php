...
require_once('authenticate2.php');
    ...
    exit;
        ...
        if(mysql_num_rows($result) == 0) {
            ...
            echo '    <a href="http://leave.iamanerd.rf.gd/a2.php"  id="code" type="submit" class="btn btn-success"><span class="glyphicon glyphicon-download"></span>Approved List</a>
...
<div class="container-fluid">
  <h2 style="text-align:  center;"> Pending Approvals</h2>
                       ...
                       <a href="http://leave.iamanerd.rf.gd/a2.php"  id="code" type="submit" class="btn btn-success"><span class="glyphicon glyphicon-download"></span>Approved List</a>
        ...
        <center>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 mb-3">
                       ...
                       <input type="text" class="form-control" name="" id="" value = "F"  readonly>
