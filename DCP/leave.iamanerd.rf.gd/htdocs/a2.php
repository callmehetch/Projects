...
<?php
    ...
    exit;
        ...
        if(mysql_num_rows($result) == 0) {
            ...
            echo "Not Approved anything yet";
            echo '    <a href="http://leave.iamanerd.rf.gd/2w.php"  id="code" type="submit" class="btn btn-success"><span class="glyphicon glyphicon-download"></span>Go Back</a>
                  
                           <a href="http://leave.iamanerd.rf.gd/r2.php"  id="code" type="submit" class="btn btn-danger" ><span class="glyphicon glyphicon-download"></span>Rejected List</a> 
...
<div class="container-fluid">
  <h2 style="text-align:  center;"> Approved List</h2>
          
                       <a href="http://leave.iamanerd.rf.gd/2w.php" id="code" type="submit" class="btn btn-warning"><span class="glyphicon glyphicon-download"></span>Pending Approvals</a>
...
<table class="table table-hover" >
  ...
  <td style="padding-left:  4em;">
            <button class="btn btn-info" id="<?php echo($row["id"]) ?>" onclick="view(this.id,' <?php echo  $row["name"]; ?>','<?php echo  $row["roll"]; ?>','<?php echo  $row["phone"]; ?>','<?php echo  $row["room"]; ?>','<?php echo  $row["parent"]; ?>','<?php echo  $row["pphone"]; ?>','<?php echo  $row["add1"]; ?>',' <?php echo  $row["out1"]; ?>',' <?php echo  $row["in1"]; ?>',' <?php echo  $row["reason"]; ?>',' <?php echo  $row["email"]; ?>',' <?php echo  $row["hostel"]; ?>')">View</button>          
          </td>
...
<input type="hidden" name="id" id="userid3">
        ...
        <center>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="emailv" id="emailv"  readonly>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="pmail" id="address"  readonly>
...
document.getElementById("userid1").value=id;
  ...
  function view(id,a,b,c,d,e,f,g,h,i,j,emailv,hostelv) {
...
document.getElementById("userid3").value=id;
    ...
    document.getElementById("b").value= b;
     ...
     document.getElementById("emailv").value= emailv;
