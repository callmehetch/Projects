...
$mail->setFrom('warden_boys@iiitdm.ac.in', 'Jagadeesh Kakarla');
    ...
    $body = '<p>Dear Parent, your son has taken permission from the hostel office to visit home from '.$out1.' to '.$in1.'. He informed us that you also know his travelling plan, if not please contact the hostel office immediately.</p>';
    $mail->isHTML(true);                                  // Set email format to HTML
